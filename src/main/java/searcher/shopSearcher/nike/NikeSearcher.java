...
public class NikeSearcher implements Searcher {
    ...
    final String ADDRESS = "https://www.nike.com";
    final int TIMEOUT = 5000;
    final String SHOP_NAME = "Nike";
    ...
    public List<Offer> getOffers(String shoeName, boolean genderMale, String size) {
        ...
        Set<URL> linksOnPage;
        if (genderMale) {
            linksOnPage = contentSearcher.getLinksOnPage(ADDRESS + "/pl/w/mezczyzni-nik1"
    ...
    private Offer getOffer(String html, URL url, String shoeName) {
        ...
        NikeInfoPicker picker = new NikeInfoPicker();
